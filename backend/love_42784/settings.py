"""
Django settings for love_42784 project.
...
WSGI_APPLICATION = 'love_42784.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "love_42784 API",
    "DESCRIPTION": "API documentation for love_42784 App",
    "VERSION": "v1",
}
